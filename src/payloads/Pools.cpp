...
auto Pool::operator==(const Pool &other) const -> bool {
    return id == other.id && denomination == other.denomination && fees == other.fees && timeout == other.timeout &&
           current_peers == other.current_peers && total_peers == other.total_peers;
}
